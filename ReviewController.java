...
//	 리뷰 출력
	...
	public ModelAndView selectAllList() {
		ModelAndView mav = new ModelAndView("/review/review_list");
		ArrayList<Review> allReviewList = 
				(ArrayList<Review>) review_Service.selectAllReview();
		mav.addObject("list", allReviewList);
		return mav;
